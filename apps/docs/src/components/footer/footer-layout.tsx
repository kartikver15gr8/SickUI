    ...
    <div className="px-4 sm:px-6 md:px-10 lg:px-14 xl:px-28 2xl:px-40 border-t-[0.5px] border-[#565555]">
      <div className="flex items-center justify-between  border-b-[0.5px] border-[#565555] h-24 md:h-40">
        <div className="flex items-center gap-x-2 lg:gap-x-4">
          <Image
            className="w-5 sm:w-6 md:w-8 lg:w-10 xl:w-12 rounded md:rounded-md lg:rounded-lg xl:rounded-xl"
      ...
      <div className="grid grid-cols-2 gap-y-10 md:gap-y-0 md:grid-cols-4 py-10">
        <div className=" col-span-1">
          ...
          <ul className="flex flex-col mt-8 gap-y-4 text-[14px] lg:text-[16px]  ">
        ...
        <div className=" col-span-1 ">
          ...
          <ul className="flex flex-col mt-8 gap-y-4  ">
            <a
      ...
      <div className="border-t-[0.5px] border-[#565555] h-20 flex items-center justify-between font-extralight  text-[12px] sm:text-[13px] lg:text-sm">
        ...
        <div className="flex items-center gap-x-2 sm:gap-x-4 lg:gap-x-8">
          <Link
            href="/terms"
            className="w-fit hover:cursor-pointer transition-all duration-200 cursor-pointer"
          >
            Terms & Conditions
          </Link>
          <Link
